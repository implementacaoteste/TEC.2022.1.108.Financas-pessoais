...
namespace DAL
{
    public class DespesasDAL
    {
        ...
        public SituacaoFinanceira BuscarSituacaoFinanceiraBanco(string _banco)
        {
            ...
            {
                throw new Exception("Ocorreu um erro ao tentar buscar a situação financeira por banco no banco de dados", ex) { Data = { { "Id", 22 } } };
            }
        }
        public SituacaoFinanceira BuscarSituacaoFinanceiraDescricao(string _descricao)
        {
            ...
            {
                throw new Exception("Ocorreu um erro ao tentar buscar a situação financeira por descrição no banco de dados", ex) { Data = { { "Id", 23 } } };
            }
        }
